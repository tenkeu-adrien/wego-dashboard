...
export default function UsersDatatable() {
  const [users, setUsers] = useState([...usersListt]);
  ...
  const addUser = (newUser) => {
    console.log("donner de l'utilisateur", newUser);
    
    // Assurez-vous que 'role' est une chaîne de caractères, pas un tableau
  
    // Ajoutez l'utilisateur avec la structure attendue
    setUsers((prevUsers) => [
      ...prevUsers,
      {
        ...newUser,
        ...
        status: false,
        role: "Admin", // Si 'role' est un tableau, il prend la première valeur
      },
    ]);
  };
  ...
  return (
    <Page title="Users Account">
      <div className="transition-content w-full pb-5">
        ...
        >
          <Toolbar table={table}  onAddUser={addUser} />
          <div
            className={clsx(
