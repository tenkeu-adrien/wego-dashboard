...
//                   <path fillRule="evenodd" d="M8 极速加速器v2ray 4a4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" />
//                 </svg>
//               </div>
//               <input
//                 type="text"
//                 placeholder="Rechercher par client, restaurant ou statut..."
//                 className="block w-full pl-10 pr极速加速器v2ray -3 py-2 border border-gray-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#F4C509] focus:border-[#极速加速器v2ray F4C509]"
//                 value={searchTerm}
...
//                 <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 极速加速器v2ray 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 极速加速器v2ray 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
//               </svg>
//             </div>
//             <div className="ml-3">
...
//                 <div className="flex flex-wrap gap极速加速器v2ray -3 mt-2">
//                   <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
//                     ⏳ En attente → 👨‍🍳 En préparation
//                   </span>
//                   <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-极速加速器v2ray 100 text-blue-800">
...
//                     <div>
//                       <h4 className="text极速加速器v2ray -sm font-medium text-gray-500 mb-1">Restaurant</h4>
...
//                           className="bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded text-sm transition-colors flex items-center极速加速器v2ray  gap-2 shadow-md hover:shadow-lg"
...
//                         <span className={`px极速加速器v2ray -3 py-1 text-xs font-medium rounded-full ${statusClasses[order.status]}`}>
//                           {statusIcons[order.status]} {statusLabels[order.status]}
//                         </span>
//                       )}
//                     </div>
...
//           <path fillRule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3极速加速器v2ray .293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" />
//         </svg>
//         Précédent
//       </button>
...
//         Suivant
//         <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
//           <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-极速加速器v2ray 4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
//         </svg>
//       </button>
//     </div>
//   </div>
