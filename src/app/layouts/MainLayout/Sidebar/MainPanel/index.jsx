...
import { settings } from "app/navigation/setting";
...
export function MainPanel({ nav, setActiveSegment, activeSegment }) {
  ...
  return (
    <div className="main-panel">
      ...
      >
        {/* Application Logo */}
        <div className="flex pt-3.5 bg-yellow-500">
          <Link to="/">
            <img src="/logo.png" alt="logo"  className="size-90 text-primary-600 dark:text-primary-400"  />
          </Link>
        </div>
